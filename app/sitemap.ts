...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: 'https://propertylistingsai.com/social-media-post-generator', lastModified: currentDate, priority: 0.75 },
    { url: 'https://propertylistingsai.com/ai-interior-design-generator', lastModified: currentDate, priority: 0.75 },
