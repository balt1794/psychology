...
export default function sitemap(): MetadataRoute.Sitemap {
  ...
  return [
    ...
    { url: 'https://propertylistingsai.com/airbnb-house-rules-generator', lastModified: currentDate, priority: 0.8 },
    { url: 'https://propertylistingsai.com/social-media-post-generator', lastModified: currentDate, priority: 0.8 },
    { url: 'https://propertylistingsai.com/ai-interior-design-generator', lastModified: currentDate, priority: 0.9 },
    { url: 'https://propertylistingsai.com/mortgage-calculator', lastModified: currentDate, priority: 0.85 },
    { url: 'https://propertylistingsai.com/fha-mortgage-calculator', lastModified: currentDate, priority: 0.85 },
    { url: 'https://propertylistingsai.com/va-mortgage-calculator', lastModified: currentDate, priority: 0.85 },
