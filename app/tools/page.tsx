  ...
  return (
    <section className="py-12 px-4 mx-auto max-w-screen-xl lg:py-16 lg:px-6">
      <div className="mx-auto max-w-screen-md text-center mb-12">
        <h2 className="mb-4 text-4xl tracking-tight font-bold text-black">Property Listing Tools</h2>
      ...
      <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-6">
        ...
        <div className="flex flex-col p-6 rounded-lg border-2 border-gray-200 shadow-md hover:shadow-lg transition-shadow">
          ...
          <h3 className="text-xl font-bold mb-2">Listing Generator</h3>
        ...
        <div className="flex flex-col p-6 rounded-lg border-2 border-gray-200 shadow-md hover:shadow-lg transition-shadow">
          ...
          <h3 className="text-xl font-bold mb-2">Photo Enhancer</h3>
          <p className="text-gray-600 mb-4">
            Optimize your property photos to make them more appealing to potential guests.
          </p>
          <div className="mt-auto">
            <a href="#" className="inline-flex items-center text-[#FF385C] font-medium">
              Try it now <ArrowRight className="ml-1 h-4 w-4" />
        ...
        <div className="flex flex-col p-6 rounded-lg border-2 border-gray-200 shadow-md hover:shadow-lg transition-shadow">
          ...
          <h3 className="text-xl text-[#FF385C] font-bold mb-2">Title Creator</h3>
          <p className="text-gray-600 mb-4">
            Generate attention-grabbing titles that increase click-through rates on your listings.
          </p>
          <div className="mt-auto">
            <a href="#" className="inline-flex items-center text-[#FF385C] font-medium">
              Try it now <ArrowRight className="ml-1 h-4 w-4" />
        ...
        <div className="flex flex-col p-6 rounded-lg border-2 border-gray-200 shadow-md hover:shadow-lg transition-shadow">
          ...
          <p className="text-gray-600 mb-4">
            Generate driving directions to help guests get to your property.
          </p>
          <div className="mt-auto">
