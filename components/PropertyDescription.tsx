...
<div className="absolute inset-0 bg-black opacity-90"></div>
  */}
      ...
      <div className="text-center mb-4">
        <h1 className="text-4xl md:text-5xl font-bold mb-4 mt-4 text-[#FF385C]">Property Description Generator</h1>

        <p className="text-xl md:text-2xl text-gray-700 mb-8">
          Turn your property photos into compelling property descriptions that attract more bookings
        </p>

        <div className="bg-gray-50 border border-gray-200 rounded-lg p-6 text-left">
          <h2 className="text-2xl font-semibold mb-4 text-gray-800">
            Create Stunning Property Descriptions from Your Photos
          </h2>

          <p className="text-gray-700 mb-4">
            Our Property Description Generator analyzes your property photos and transforms them into
            engaging, detailed descriptions that highlight your space's best features and unique selling points.
          </p>

          <p className="text-gray-700 mb-4">
            Stop struggling with writer's block or generic descriptions. Our tool identifies specific details in your
            photos—from architectural features to decor elements—and crafts a professional description that makes your
           property listing stand out from the competition.
          </p>
...
<div className="h-screen">
        ...
        <div className="flex flex-wrap justify-between w-full max-w-8xl p-4 lg:p-10  ">
          ...
          <div className="w-full md:w-1/2  shadow-lg p-8 text-black mb-8 rounded-lg md:mb-0 border-solid border-4 border-white-400 ">
            <h2 className="text-xl  text-[#FF385C] font-bold mb-4">Property Descriptions - Upload Images</h2>
        ...
        >
          Generate Listing
            ...
            // User is not logged in
            <button type="button" onClick={handleGenerateListingClick} className="sm:inline-block text-white px-3 text-md font-medium border-solid border-4 border-white-400 rounded-lg bg-[#FF385C] p-1 text-black hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800 overflow-hidden whitespace-nowrap truncate">
  ...
  <div className="w-full md:w-1/2 border-solid border-t-4 border-r-4 border-b-4 border-white-400 rounded-lg shadow-md p-8 text-black">
    <div className="border-t border-gray-300 pt-4">
      ...
      <div className="flex justify-center mt-4">
        <button
          className="sm:inline-block text-black px-3 text-md font-medium border-solid border-4 border-white-400 rounded-full bg-[#FF385C] p-1 text-black hover:bg-gray-100 focus:outline-none focus:ring-2 focus:ring-white focus:ring-offset-2 focus:ring-offset-gray-800 overflow-hidden whitespace-nowrap truncate"
